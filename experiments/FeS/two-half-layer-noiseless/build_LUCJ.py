...
ucj_op_3layer = ffsim.UCJOpSpinBalanced.from_t_amplitudes(
    t2=ccsd.t2, t1=ccsd.t1, n_reps=3,
    interaction_pairs=(alpha_alpha_indices, alpha_beta_indices),
)

ucj_op = ffsim.UCJOpSpinBalanced(
    diag_coulomb_mats=ucj_op_3layer.diag_coulomb_mats[:2],
    orbital_rotations=ucj_op_3layer.orbital_rotations[:2],
    final_orbital_rotation=ucj_op_3layer.orbital_rotations[2].T.conj(),
)
