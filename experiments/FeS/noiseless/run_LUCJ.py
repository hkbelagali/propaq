...
print(f"Evaluating weight-{weight} terms with damping={damping} and cutoff={cutoff}")
...
cutoff_exp = int(round(-np.log10(cutoff)))
tag = f"w{weight}_c{cutoff_exp}_{task_id:05d}of{n_tasks:05d}"
